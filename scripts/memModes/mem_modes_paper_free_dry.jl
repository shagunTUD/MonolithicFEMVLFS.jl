...
function run_case(mfac = 0.9, tfac = 0.1)
  ...
  name::String = "data/sims_202403/mem_modes_free/dry_eigen/mem_modes_"*caseName
  order::Int = 2
  ...
  # add_tag_from_tags!(labels_Ω,"surface",[1,2,3])   # assign the label "surface" to the entity 3,4 and 6 (top corners and top side)
