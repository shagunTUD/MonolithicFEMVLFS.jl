...
plot!(plt1, xka / Lm .- 4, abs.(ηₕ.(prbxka)) / amp, 
...
xka = 50:dx:80
prbxka = Point.(xka, 0.0)
plot!(plt1, xka / Lm .- 4, abs.(κr.(prbxka)) / amp, 
...
xka = 50:dx:80
prbxka = Point.(xka, 0.0)
plot!(plt1, xka / Lm .- 4, abs.(κin.(prbxka)) / amp, 
...
xka = 50:dx:80
prbxka = Point.(xka, 0.0)
plot!(plt1, xka / Lm .- 4, abs.(κₕ.(prbxka)) / amp, 
