...
function give_material(name::String)
    Materials_dict = Dict( 
        "hdpePhil" => [250, 12e9], #Wrong values. Taken from Regeout thesis.
        "hdpe" => [952, 500e6], #solid
        "cfrp" => [960.432, 40e9], #Carbon fiber reinforced polymer based on https://doi.org/10.1016/j.matpr.2020.07.636, lower end is used (conservative)
    )
