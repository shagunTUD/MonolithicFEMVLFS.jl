...
name::String = "data/sims_202212/BeamMultJoints-freq2-method3"
order::Int = 2
...
Lb = 300 #m
hb = 2 #m
ρb = 250 # density kg/m3
E = 12e9 #Young's modulus [N/m2]
I = 1/12 * hb^3
EI = E*I
β = (0.25, 0.5, 0.75) # relative location of joints
ξ = 0.0
nj = length(β) # num_of_joints
d₀ = γ1*ρb*hb/ρw #draft of the floating body
Dᵨ = γ1^3 * EI/ρw
kᵣ = ξ*Dᵨ/Lb


# Wave parameters
H0 = 30 #m #still-water depth, atleast at inlet
λ = 140 #m #wave-length
η₀ = 1.25/2.0 #m #wave-amplitude
k = 2π/λ
